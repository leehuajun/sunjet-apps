...
//            "select * from sys_icons");
    ...
    parameters.put("docNo", request.getParameter("docNo"));
    parameters.put("dealerName", request.getParameter("dealerName"));
    parameters.put("dealerCode", request.getParameter("dealerCode"));
    parameters.put("dealerAdderss", request.getParameter("dealerAdderss"));
    parameters.put("receive", request.getParameter("receive"));
    parameters.put("operatorPhone", request.getParameter("operatorPhone"));
    parameters.put("agencyName", request.getParameter("agencyName"));
    parameters.put("agencyCode", request.getParameter("agencyCode"));
    parameters.put("submitterName", request.getParameter("submitterName"));
    parameters.put("orValue", "");
