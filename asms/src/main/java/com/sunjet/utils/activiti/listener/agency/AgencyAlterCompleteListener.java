...
//    }
    ...
    public void notify(DelegateExecution execution) throws Exception {
        ...
        AgencyAlterRequestEntity alterRequest = agencyAlterService.findOneById(businessId);
        // 3. 获取业务对象的某个属性
        AgencyEntity agencyEntity = alterRequest.getAgency();
        String agency_id = agencyEntity.getObjId();
        // 赋值
