 ...
 */
public class AgencySettlementReportVM extends FormBaseVM {
...
//        JSONArray jsonArray = JSONArray.fromObject(iconList);
        ...
        this.reportUrl = "/views/report/settlement/agencySettlementReport.jsp?data=" + data + "&report=agencySettlement.jasper";
