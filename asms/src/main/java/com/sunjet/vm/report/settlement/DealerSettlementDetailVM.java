 ...
 */
public class DealerSettlementDetailVM extends FormBaseVM {
...
//        JSONArray jsonArray = JSONArray.fromObject(iconList);
        ...
        this.reportUrl = "/views/report/settlement/dealerSettlementDetail.jsp?" +
                "data=" + data
                + "&startDate=" + startDate
                + "&endDate=" + endDate
                + "&report=dealerSettlementDetail.jasper";
