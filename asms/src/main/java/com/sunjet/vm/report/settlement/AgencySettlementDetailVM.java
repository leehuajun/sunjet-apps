 ...
 */
public class AgencySettlementDetailVM extends FormBaseVM {
...
//        JSONArray jsonArray = JSONArray.fromObject(iconList);
        ...
        this.reportUrl = "/views/report/settlement/agencySettlementDetail.jsp?" +
                "data=" + data
                + "&startDate=" + startDate
                + "&endDate=" + endDate
                + "&report=agencySettlementDetail.jasper";
