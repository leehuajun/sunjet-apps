 ...
 */
public class DealerSettlementReportVM extends FormBaseVM {
...
//        JSONArray jsonArray = JSONArray.fromObject(iconList);
        ...
        this.reportUrl = "/views/report/settlement/dealerSettlementReport.jsp?data=" + data + "&report=dealerSettlement.jasper";
