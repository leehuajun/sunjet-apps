package com.sunjet.vm.report.settlement;
 ...
 */
public class FreightSettlementReportVM extends FormBaseVM {
...
//        JSONArray jsonArray = JSONArray.fromObject(iconList);
        ...
        this.reportUrl = "/views/report/settlement/freightSettlementReport.jsp?data=" + data + "&report=freightSettlement.jasper";
