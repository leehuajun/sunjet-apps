 ...
 */
public class FreightSettlementDetailVM extends FormBaseVM {
...
//        JSONArray jsonArray = JSONArray.fromObject(iconList);
        ...
        this.reportUrl = "/views/report/settlement/freightSettlementDetail.jsp?" +
                "data=" + data
                + "&startDate=" + startDate
                + "&endDate=" + endDate
                + "&report=freightSettlementDetail.jasper";
