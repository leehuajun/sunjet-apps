 ...
 */
public class WarrantyMaintenanceRrintVM extends FormBaseVM {
...
//  private Component iframe;
    ...
    public void init() {
        ...
        this.reportUrl = "/views/report/asm/warrantyMaintenance.jsp?objId=" + objId
                + "&report=warrantyMaintenance.jasper";
