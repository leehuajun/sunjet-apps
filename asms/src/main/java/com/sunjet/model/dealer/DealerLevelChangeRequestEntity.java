 ...
 */
@Entity
@Table(name = "DealerLevelChangeRequests")
public class DealerLevelChangeRequestEntity extends FlowDocEntity {
    private static final long serialVersionUID = -1570254319994716023L;
    private DealerEntity dealer;      // 服务站信息

    private String fileLevelChange; //  变更函
...
//    private String cityName;          // 市名称
    ...
    @Column(length = 200)
    public String getFileLevelChange() {
        return fileLevelChange;
    }

    public void setFileLevelChange(String fileLevelChange) {
